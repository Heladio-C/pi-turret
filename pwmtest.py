...
def angle_to_duty(angle):
    # 50 Hz -> 20 ms period. Servo pulse 0.5-2.5 ms = duty 2.5%-12.5%.
    angle = max(TILT_MIN_ANGLE, min(TILT_MAX_ANGLE, angle))
    return 2.5 + (angle - TILT_MIN_ANGLE) / (TILT_MAX_ANGLE - TILT_MIN_ANGLE) * 10.0
